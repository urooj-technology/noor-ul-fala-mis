export const commonEn = {
  ...
  calendar: {
    ...
    dateFormatDescription: "Choose how dates appear in forms, tables, and reports.",
    formatSlash: "YYYY/MM/DD",
    formatDash: "YYYY-MM-DD",
    formatEuropean: "DD/MM/YYYY",
    formatMonthName: "Day Month Year",
    datePreview: "Preview — today",
    saved: "Calendar preference saved",
    formatSaved: "Date format saved",
    shamsiMonth1: "حمل",
    shamsiMonth2: "ثور",
    shamsiMonth3: "جوزا",
    shamsiMonth4: "سرطان",
