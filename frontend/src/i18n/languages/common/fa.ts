export const commonFa = {
  ...
  calendar: {
    ...
    dateFormatDescription: "نحوه نمایش تاریخ در فرمها، جداول و گزارشها را انتخاب کنید.",
    formatSlash: "سال/ماه/روز",
    formatDash: "سال-ماه-روز",
    formatEuropean: "روز/ماه/سال",
    formatMonthName: "روز ماه سال",
    datePreview: "پیش‌نمایش — امروز",
    saved: "تنظیمات تقویم ذخیره شد",
    formatSaved: "فرمت تاریخ ذخیره شد",
    shamsi: "شمسی",
