export const studentsEn = {
  ...
  outstandingReport: "Student Payment Reports",
  outstandingReportDesc: "View student fee payments by full paid, unpaid, and partially paid status",
  totalsByCurrency: "Totals by Currency",
  outstandingDetails: "Student Payment Details",
