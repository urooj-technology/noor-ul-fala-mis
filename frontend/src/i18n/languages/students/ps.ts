export const studentsPs = {
  ...
  registrationPeriod: "د نوم لیکنې موده",
  selectRegistrationPeriod: "د نوم لیکنې موده وټاکئ",
  registrationDateFrom: "نوم لیکنه له",
  registrationDateTo: "نوم لیکنه تر",
  selectRegistrationDateFrom: "د پیل نېټه وټاکئ",
  selectRegistrationDateTo: "د پای نېټه وټاکئ",
  ...
  studentsInPeriod: "زده‌کوونکي په ټاکل شوې موده کې",
  printFiltered: "فلټر شوي زده‌کوونکي چاپ کړئ",
  printSelected: "ټاکل شوي چاپ کړئ",
  studentFinancialReport: "د زده‌کوونکو مالي راپور",
  totalStudents: "ټول زده‌کوونکي",
  exportExcel: "اکسل صادرول",
  exportingExcel: "صادرېږي...",
  exportExcelHint: "دا راپور ډیر ستونونه لري. د ښه لید لپاره اکسل وکاروئ.",
  printColumns: {
    regNo: "ثبت نمبر",
    name: "نوم",
    class: "صنف",
