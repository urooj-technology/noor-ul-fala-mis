export const accountingFa = {
  ...
  // Account Category
  addAccountCategory: "افزودن کتگوری حساب",
  editAccountCategory: "ویرایش کتگوری حساب",
  accountCategoryDetails: "جزئیات کتگوری حساب",
  accountCategoryName: "نام کتگوری",
  accountCategoryCode: "کد کتگوری",
  ...
  accountCategoryPlaceholder: "کتگوری حساب را انتخاب کنید",
