        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <NumericInput maxDecimals={2} id="monthly_rent" value={formData.monthly_rent} onChange={(e) => { setFormData((prev) => ({ ...prev, monthly_rent: e.target.value })); if (errors.monthly_rent) setErrors((prev) => ({ ...prev, monthly_rent: "" })); }} className="h-10" />
